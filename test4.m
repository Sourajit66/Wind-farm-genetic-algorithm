...
% turb_coords  = (readtable(layoutFile)); 
% x=fitnessfunc(turb_coords)
sasu=([]);
for k=1:100
...
x=fitnessfunc(w);
w=table2array(w);
sas1=struct('coordinates',w,'AEP',x);
sasu=[sas1 sasu];
end
save('bigdata1','sasu')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load ('totalwind','total')

%% 
for j=1:7
% Load Data Files and Read
% Turbine x,y coordinates
%layoutFile = 'Shell_Hackathon Dataset\.csv';
% Power curve
